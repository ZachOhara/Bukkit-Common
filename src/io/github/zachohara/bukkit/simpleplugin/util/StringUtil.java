...
/**
 * The {@code StringUtil} class contains some common strings that are exchanged between the server and the
 * players using it.
 *
 * @author Zach Ohara
 */
public final class StringUtil {
	 ...
	 */
	public static final String ERROR_CONSOLE_ONLY_MESSAGE = "This command is only usable by the console";
